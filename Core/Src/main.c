...
/* USER CODE BEGIN PV */
// Variables to store ADC reading and calculated temperatures
uint16_t readValue; // Value read from ADC
float tCelsius; // Temperature in degrees Celsius
float tFahrenheit; // Temperature in degrees Fahrenheit
